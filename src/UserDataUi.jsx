...
const UserDataUi = ({ users }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 sm:p-8">
      <div className="flex flex-col sm:flex-row items-center  justify-between md:justify-center gap-3 md:gap-10 pt-5 sm:pt-0">
        <input
          type="text"
          placeholder="Search user by name..."
          className="px-5 py-2 border-2 border-blue-500 rounded-3xl outline-none w-[90%] sm:w-150"
